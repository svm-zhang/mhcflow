...
BEGIN {
	our $VERSION = "0.1";
	our @ISA = qw(Exporter);
	our @EXPORT = qw(split_lik get_likelihood_msf get_match_string get_seq_msfs
	get_msf2Seq_pos get_read_alleles get_alleles get_msf get_seq_and_qual
	get_likelihood_log get_klikelihood md_to_match_string get_score_hash_both
	get_score_hash_log get_score_hash get_err_hash_illumina convert_hla_name
	get_4digit population_prior_likelihood_component population_prior_likelihood
	process_read_pairs_second process_read_pairs insert_score process_insert_size
	likelihood_score likelihood_score2 get_race get_hla_frequencies median
	get_winning_pair process_insert_size_median found_arr)
}
