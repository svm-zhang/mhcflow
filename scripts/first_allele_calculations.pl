...
#use FindBin qw($Bin);
#use lib "$Bin/../lib";
use PolysolverUtils qw(get_hla_frequencies population_prior_likelihood_component get_err_hash_illumina
	get_score_hash_log md_to_match_string get_likelihood_log );
...
my $iFile = "0";
my $includeFreq = 1;
my $PSHOME = "/home/simo/code/jshla";
